...
", pat="pcap", replace="c_pcap")
parseStructInfos("
c_bpf_insn{SCCI}code jt jf k ;
c_bpf_program{I*<bpf_insn>}bf_len bf_insns ;
c_pcap_addr{*<pcap_addr>*<sockaddr>*<sockaddr>*<sockaddr>*<sockaddr>}next addr netmask broadaddr dstaddr ;
c_pcap_dumper{};
c_pcap_file_header{ISSiIII}magic version_major version_minor thiszone sigfigs snaplen linktype ;
c_pcap_if{*<pcap_if>*c*c*<pcap_addr>I}next name description addresses flags ;
c_pcap_pkthdr{<timeval>II}ts caplen len ;
c_pcap_stat{III}ps_recv ps_drop ps_ifdrop ;
c_pcap{};
c_sockaddr{};
c_timeval{ji}tv_sec tv_usec ;
")
PCAP_D_IN=1;
PCAP_D_INOUT=0;
PCAP_D_OUT=2;
